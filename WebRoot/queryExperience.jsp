...
<script src="js/custom.js" type="text/javascript"></script>
 ...
 <body>
  ...
  <div class="container">
	...
	<form action="experience/experienceAction!queryByTitle" method="post" class="form-horizontal">
		<div class="form-group">
			<div class="col-sm-8">
				<input type="text" name="title" class="form-control" placeholder="输入关键字">
			</div>
			<div class="col-sm-4">
				<input type="submit" class="btn btn-default" onclick="return check()"/>
			</div>
		</div>
	</form>
	<div class="container-new">
		<h1>热门推荐&nbsp;<small><span class="glyphicon glyphicon-fire"></span></small></h1>
