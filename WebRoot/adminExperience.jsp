 ...
 <body>
  <div class="container">
		...
		<nav class="navbar navbar-default" id="meumtop">
			<div
				...
				<ul class="list-unstyled nav1 cl-effect-10">
					...
					<li role="presentation"><a data-hover="审核心得" class="active"
	...
	<!-- <ul class="nav nav-tabs">
	  ...
	  <li role="presentation" class="active"><a>审核心得</a></li>
		...
		<th>
			...
			<s:iterator value="experiences" id="e">
				<tr>
					...
					<td><a href="experience/experienceAction!updatePass?id=<s:property value="id" />&pass=1">通过</a></td>
					<td><a href="experience/experienceAction!updatePass?id=<s:property value="id" />&pass=2">不通过</a></td>
