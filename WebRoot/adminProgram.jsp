 ...
 <body>
  <div class="container">
		...
		<nav class="navbar navbar-default" id="meumtop">
			<div
				...
				<ul class="list-unstyled nav1 cl-effect-10">
					<li role="presentation"><a data-hover="审核方案"  class="active"
	...
	<!-- <ul class="nav nav-tabs">
	  <li role="presentation" class="active"><a>审核方案</a></li>
		...
		<th>
			...
			<s:iterator value="programs" id="p">
				<tr>
					...
					<td><a href="upload/<s:property value="pictureUrl" />" target="_blank" role="button" class="btn btn-default">查看原图</a></td>
					<td><a href="program/programAction!updatePass?id=<s:property value="id" />&pass=1">通过</a></td>
					<td><a href="program/programAction!updatePass?id=<s:property value="id" />&pass=2">不通过</a></td>
