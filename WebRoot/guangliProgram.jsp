 ...
 <body>
  ...
  <!--header--->
		...
		<nav class="navbar navbar-default" id="meumtop">
			<div
				...
				<ul class="list-unstyled nav1 cl-effect-10">
					...
					<li role="presentation"><a data-hover="管理方案" class="active" href="guangliProgram.jsp"><span>管理方案</span></a>
					</li>
	...
	<!-- <ul class="nav nav-tabs">
	  ...
	  <li role="presentation" class="active"><a>管理方案</a></li>
	...
	<form action="program/programAction!queryByTitleAndPass" class="form-inline">
	...
	<s:if test="#request.pageNum != null">
		...
		<th>
			...
			<s:iterator value="programs" id="p">
				<tr>
					<td></td>
					<td><a target="_blank" href="program/programAction!adminQueryById?id=<s:property value="id" />"><s:property value="title" /></a></td>
					<td><s:property value="writerName" /></td>
					<td><s:property value="writeTime" /></td>
					<td><a target="_blank" href="upload/<s:property value="pictureUrl" />" role="button" class="btn btn-default">查看原图</a></td>
					<td><a href="program/programAction!admindelete?id=<s:property value="id" />">删除</a></td>
				</tr>
			</s:iterator>
		</table>
	</s:if>
		...
		<nav style="text-align: center">
			<ul class="pagination">
				<li><s:if test="#request.pageNum==1">
						<a href="program/programAction!queryByTitleAndPass?title=<s:property value="programVo.title"/>&pass=<s:property value="programVo.pass"/>&pageNum=1"
							aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a>
					</s:if> <s:else>
						<a href="program/programAction!queryByTitleAndPass?title=<s:property value="programVo.title"/>&pass=<s:property value="programVo.pass"/>&pageNum=<s:property value="#request.pageNum-1"/>" 
							aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a>
					</s:else>
				</li>
				<s:bean name="org.apache.struts2.util.Counter" id="counter">
					...
					<s:iterator status="count">
						<s:if test="#request.pageNum != #count.index+1">
							<li><a href="program/programAction!queryByTitleAndPass?title=<s:property value="programVo.title"/>&pass=<s:property value="programVo.pass"/>&pageNum=<s:property />"><s:property /></a></li>
						</s:if>
						<s:else>
				...
				<s:if test="#request.pageNum==#request.pagesNum">
						<a href="program/programAction!queryByTitleAndPass?title=<s:property value="programVo.title"/>&pass=<s:property value="programVo.pass"/>&pageNum=<s:property value="#request.pageNum"/>"
